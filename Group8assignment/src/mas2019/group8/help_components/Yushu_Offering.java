...
public class Yushu_Offering extends OfferingStrategy {
	...
	public Yushu_Offering(NegotiationSession negoSession, OpponentModel model, OMStrategy oms, Map<String, Double> parameters) {
		try {
			System.out.println(negoSession);
			init(negoSession, model, oms, parameters);
		} catch (Exception e) {
